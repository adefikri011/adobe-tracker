...
// --- Animasi Variants (Sama seperti Landing Page & Login) ---
const fadeUp = {
      ...
      >
        ...
        <motion.div variants={fadeUp} custom={0} className="text-center mb-8">
          ...
          <p className="text-slate-500 font-medium">
            Start tracking your Adobe Stock assets
          </p>
        </motion.div>
        ...
        >
          ...
          <motion.p variants={fadeUp} custom={6} className="text-center text-slate-500 text-sm mt-6 font-medium">
            ...
            <Link href="/login" className="text-orange-500 hover:text-orange-600 font-bold transition-colors inline-flex items-center gap-1 group">
              Sign in
